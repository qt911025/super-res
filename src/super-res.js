 ...
 * @param url{String}
 * @param defaultParams{Object} Default query parameters
 * @param actions{Object} Custom actions
 * @param commonOptions{Object} Default options of this resource
 * @param enforceFixMethod{Boolean} Whether to correct the method of reserved-word actions with default one,
